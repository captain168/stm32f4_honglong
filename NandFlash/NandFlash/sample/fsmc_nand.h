...
** Version:                 v1.1
** Descriptions:            Add member Fifth_ID in NAND_IDTypeDef
**                          Chang FSMC_NAND_WriteSmallPage to FSMC_NAND_WritePage
**                          Chang FSMC_NAND_ReadSmallPage to FSMC_NAND_ReadPage
**
*********************************************************************************/
