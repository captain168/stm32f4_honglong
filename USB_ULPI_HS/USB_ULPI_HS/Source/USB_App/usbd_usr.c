...
//   
   ...
   printf("\n\rUSB OTG HS MSC Device!\n\r");
 #else
   printf("\n\rUSB OTG FS MSC Device!\n\r");
 #endif
   printf("\n\r> USB device library started.\n\r");
   printf("\n\r     USB Device Library v1.1.0\n\r");
...
void USBD_USR_DeviceReset (uint8_t speed)
{
 switch (speed)
 {
   ...
   printf("\n\r     USB Device Library v1.1.0  [HS]\n\r");
//      LCD_LOG_SetFooter ("     USB Device Library v1.1.0  [HS]" );
     break;

  case USB_OTG_SPEED_FULL: 
  printf("\n\r      USB Device Library v1.1.0  [FS]\n\r");
