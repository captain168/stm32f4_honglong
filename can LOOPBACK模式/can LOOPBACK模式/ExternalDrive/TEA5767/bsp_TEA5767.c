...
*
* 文件名: bsp_TEA5767.c
* 内容简述: TEA5767 FM收音机芯片驱动
*
* 文件历史:
* 版本号 日期       作者    说明
* 1.0    2010-09-11 armfly  创建该文件
*
*/
#include "stm32f4xx.h"
...
/****************************************************************************
* 函数名: void tea5767_Write
* 功  能: 设置TEA5767, 连续写入_count个字节;
* 输  入: _ucaBuf ： 待写入的数据;
*         _count  : 数据个数
* 输  出: 无.
* 返  回: 无.
...
/****************************************************************************
* 函数名: void tea5767_Write
* 功  能: 读取TEA5767的寄存器, 连续读出5个字节，存放在_ucaBuf
* 输  入: _ucaBuf ： 结果缓冲区指针
* 输  出: 结果存放在_ucaBuf.
* 返  回: 无.
*/
